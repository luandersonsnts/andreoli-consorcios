      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-bold text-firme-gray mb-2">Você fala com o nosso time</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-firme-gray mb-2">Nós te mostramos todas</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-firme-gray mb-2">Você escolhe</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-firme-gray mb-2">Nosso time proporciona total suporte</h3>
