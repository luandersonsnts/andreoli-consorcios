...
const testimonials = [
  {
    text: "Graças ao acompanhamento da Cavalcante Investimentos, consegui multiplicar meu patrimônio e já estou próximo da minha independência financeira. O atendimento é excepcional!",
    name: "Carlos Eduardo",
    role: "Empresário",
...
export default function Testimonials() {
  ...
  return (
    <section id="clientes" className="py-16 bg-cavalcante-light-gray">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-cavalcante-gray mb-4">
            Veja o que diz quem é cliente Cavalcante Investimentos:
          </h2>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center relative">
            <button 
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 text-cavalcante-orange hover:text-cavalcante-orange-light transition-colors"
            ...
            <button 
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-cavalcante-orange hover:text-cavalcante-orange-light transition-colors"
            ...
            <div className="mb-6">
              <Quote className="text-cavalcante-orange text-3xl mx-auto" />
            </div>
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-bold text-cavalcante-gray" data-testid="text-testimonial-name">{current.name}</h4>
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors ${
                    index === currentTestimonial ? 'bg-cavalcante-orange' : 'bg-gray-300'
                  }`}
        ...
        <div className="text-center mt-12">
          <h3 className="text-2xl font-bold text-cavalcante-gray mb-4">
            Seu sonho está a um <strong className="text-cavalcante-orange">clique.</strong>
          </h3>
